...
const videoWeighting = [0, 0, 0, 1, 1];
const Video = React.memo(() => (
  <iframe
    title="background-video"
    src={`https://www.youtube.com/embed/${videoIDs[videoWeighting[Math.floor(Math.random() * 10) % 5]]}?autoplay=1&mute=1&start=${Math.floor(Math.random() * 180 + 20)}&loop=1`}
    frameBorder="0"
    allow=""
  />
));
